...
const Dashboard = () => {
  ...
  // Removed unused state: const [showFixButton, setShowFixButton] = useState(false);
    ...
    const initializeFromStore = async () => {
      ...
      if (storeAccounts && storeAccounts.length > 0) {
        ...
        if (whatsappConnected) {
          ...
          // CRITICAL FIX: WhatsApp not connected
                      ...
                      <Suspense fallback={<div className="flex items-center justify-center h-full"><div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-blue-500"></div></div>}>
                        ...
                        <div className="flex flex-col items-center justify-center h-full p-4 text-center">
                          <div className="mb-4 text-gray-400">
                            ...
                            <p className="mb-4">Please connect a messaging platform.</p>
                            <button
                              onClick={() => {
                                setShowConnectionModal(true);
                              }}
