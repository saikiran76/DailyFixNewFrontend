...
import { FiX, FiUser, FiMenu, FiCheckCircle } from 'react-icons/fi';
...
const ExpandedSettingsMenu = ({ isOpen, onClose, activeOption = 'Account' }) => {
  ...
  return (
    <ModalPortal>
      {/* The backdrop - clicking this should close the modal */}
      <div 
        className="fixed inset-0 bg-black bg-opacity-75 backdrop-blur-[2px] flex items-center justify-center"
        onClick={handleBackdropClick}
      >
        {/* The modal itself - clicking this should NOT close the modal */}
        <div 
          ref={menuRef}
...
ExpandedSettingsMenu.propTypes = {
